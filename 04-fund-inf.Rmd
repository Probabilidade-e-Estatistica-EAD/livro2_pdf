...
```{r choosingZForCI, fig.cap="A área entre -z e z aumenta ao passo que |z| torna-se maior. Se o nível de confiança é de 99 porcento, nós escolhemos z tal que 99 porcento da curva normal está entre -z e z, que corresponde a 0.005 porcento na cauda inferior e 0.005 porcento na cauda superior: z=2.58.", fig.align="center"}
...
***
```{exercise, echo=T, label = "exrdinheiro"}
...
***
```{exercise, echo=T, label = "tribunal1"}
...
***
```{exercise, echo=T, label = "tribunal2"}
...
***
```{exercise, echo=T, label = "tribunal3"}
