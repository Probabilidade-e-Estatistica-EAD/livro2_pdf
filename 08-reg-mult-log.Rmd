...
***
```{exercise, echo=T, label = 'eqForMultipleRegrOfTotalPrForAllPredictorsWithCoefficients'}
...
***
```{exercise, echo=T, label = 'computeMultipleRegressionResidualForMarioKart'}
...
```{example, echo=T, label = 'colinearityOfCondNewAndStockPhoto'}
...
***
```{exercise, echo=T, label = 'computeUnadjustedR2ForAllPredictorsInMarioKart'}
...
```{example, echo=T, label = 'backwardEliminationExampleWMarioKartData'}
...
```{example, echo=T, label = 'forwardEliminationExampleWMarioKartData'}
...
***
```{exercise, echo=T, labe3l = 'marioKartMultipleRegressionModelAllButDuration'}
...
```{example, echo=T, label = 'logisticExampleWithToMultiple'}
...
```{example, echo=T, label = 'exampleForSpamAndWinner'}
...
```{example, echo=T, label = 'exampleForSpamAndFormat'}
