...
***
```{exercise, echo=T, label = 'findingTheSlopeOfTheLSRLineForIncomeAndAid'}
...
```{example, echo=T, label = 'exampleToFindLSRLineOfElmhurstData'}
...
```{example, echo=T, label = 'outlierPlotsExample'}
...
```{example, echo=T, label = 'overallAidIncomeInformalAssessmentOfRegressionLineSlope'}
