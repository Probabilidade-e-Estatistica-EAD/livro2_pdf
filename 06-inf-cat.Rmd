...
***
```{exercise, echo=T, label = 'seOfPropOfAmericansJobApprovalOfSupremeCourt'}
...
```{example, echo=T, label = 'NuclearArmsInferenceExample'}
...
***
```{exercise, echo=T, label = 'htFormammogramStudySummaryTable'}
...
```{example, echo=T, label = 'condFormammogramStudySummaryTableNormalInference'}
...
***
```{exercise, echo=T, label = 'carWheelBladeManufacturer'}
...
***
```{exercise, echo=T, label = 'exerChiSquareDistributionDescriptionWithMoreDOF'}
...
```{example, echo=T, label = 'RejectGeomModelForSP500StockDataFor1990To2011'}
...
```{example, echo=T, label = 'googleExampleComputingTheExpectedNumberOfCurrentGroupWithNoNewSearch'}
...
***
```{exercise, echo=T, label = 'googleExampleComputingTheExpectedNumberOfNewAlgGroupWithNoNewSearch'}
...
```{example, echo=T, label = 'hypothesisTestSetupForPewResearchPollOnApprovalRatingsForChiSquareSection'}
...
***
```{exercise, echo=T, label = 'hypForAssessingConsultantWorkInLiverTransplants'}
...
***
```{exercise, echo=T, label = 'plainLanguageExplanationOfHTConclusionForLiverDonorSurgicalConsultant'}
...
```{example, echo=T, label = 'hypothesesForCPRStudyInSmallSampleSection'}
...
***
```{exercise, echo=T, label = 'exerciseComputingDifferenceForCPRStudyInSmallSampleSectionFake1'}
...
***
```{exercise, echo=T, label = 'comparisonOfLargeSampleAndSmallSamplePValueInCPRStudy'}
